...
datasets and questions, key data science tasks become both more important and
more computationally onerous.
%
\begin{itemize}
%
...
%
 ...
 My research uses {\em sensitivity analysis} to provide
fast, accurate approximations to these fundamental tasks of data science,
providing modern theory and practical software to provide orders-of-magnitude
speedup over classical methods --- all with modern theoretical guarantees.
