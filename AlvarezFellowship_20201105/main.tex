...
Consider, as examples, the following ubiquitous data science tasks.
%
\begin{itemize}
%
...
%   The solution of
% such linear systems in large, practical problems is an interesting practical
% and theoretical task in its own right.
