...
make_imbalance_plot <- function(basic_data, sim_data) {
...
alex_inter_imb <- make_imbalance_plot(alex$basic_data, alex$sim_data)
lax_inter_imb <- make_imbalance_plot(lax$basic_data, lax$sim_data)