...
but don't observe target population $\tarcol{\y_j}$.  Let $\surcol{\Ysur = \{\y_1, \ldots, \y_{\Nsur}\}}$.
...
% The MLE satisfies
% $\meansur m(\thetahat^\trans \x_i) = \meansur \y_i \x_i$.  So
$$
\begin{aligned}
...
% \begin{itemize}
% \item If $\muhat_\mrp$ is linear in $\Ysur, this definition recovers the true weights
% \item Whether or not $\muhat_\mrp$ is linear in $\Ysur, this definition is valid
%     ``locally'' for $\Ytil$ ``nearby'' $\Ysur.
