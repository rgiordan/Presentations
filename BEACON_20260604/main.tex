...
\textbf{Assume we can re-use these computations.}  How can we use them?
...
\end{aligned}
$$
Obviously we can't compute $\Vhat$. But just as obviously don't actually want all of $\Vhat$!

\textbf{Key idea:} We actually want to know is not $\x$, but
...
\textbf{Problem: }In inversion problems, the prior is informative,
and the model does smoothing.

How is your data being used?  What patterns are possible to identify?
