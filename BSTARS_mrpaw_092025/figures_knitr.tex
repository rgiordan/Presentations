...
\caption[Comparison between raking and MrPlew weights]{Comparison between raking and MrPlew weights}\label{fig:weightplot}
\end{figure}
...
{\centering \includegraphics[width=0.98\linewidth,height=0.588\linewidth]{figure/alexanderbinarypred-1} 
...
{\centering \includegraphics[width=0.98\linewidth,height=0.588\linewidth]{figure/alexanderrefit-1} 
