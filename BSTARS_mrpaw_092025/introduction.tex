...
\splitpage{
    ...
    \\[1em]
    \parencite{blueroseresearch:2024} (On Ezra Klein show, major professional pollsters)
}{
    ...
    \\[1em]
    \parencite{datademocracyblog:2025} (Berkeley professor co--author, major professional researchers)
}
\vspace{1em}
\pause
