...
%
\begin{itemize}
\item Specify an alternative model + test with Bayes factor
\citep{cabral:2025:RobustnessModelChecking2025}
%
\begin{itemize}
...
\theorem{
    \textbf{Theorem (\citet{giordano:2018:covariances}, others): }
