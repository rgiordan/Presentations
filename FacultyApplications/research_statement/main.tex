...
bias correction \citep{shao:2012:jackknife, burnham:1978:jackknifebias}.
...
% \end{itemize}
% %
% To some extent, high dimensionality and complex models can exacerbate all
% of these problems, rendering sensitivity analysis most difficult precisely when
...
sensitivity analysis with little computation beyond that required for ordinary
...
research into stochastic second-order methods could significantly speed up
sensitivity analysis in large problems. \citep{agarwal:2017:secondorder,
berahas:2020:newtonsketch}.

Finally, practitioners are often interested in non-smooth objectives. For these,
a promising idea is to use local approximations to speed up computationally
