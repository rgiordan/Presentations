...
\usepackage{tikz}
%\usepackage{ulem} % for strikeout, works badly
%\usepackage{soul} % for st (strikeout) also works badly

\usepackage[many]{tcolorbox} % For big red cross
...
\setbeamercolor{block title alerted}{fg=black,bg=yellow!90!black}
\setbeamercolor{block body alerted}{bg=block title alerted.bg!30!white}

\usepackage[style=alphabetic,maxbibnames=10]{biblatex}
%\usepackage[authoryear]{natbib}
\addbibresource{references.bib}
\AtBeginBibliography{\def\UrlFont{\relax}}

%\usepackage{alltt} % for verbatim