...
\splitpagereveal{4-}{7-}{
    ...
    \centering
    Black box! \parencite{gelman:2007:struggles}
    % \\
    % \vspace{1em}
...
Noting that 
$
\surcol{\w_i} :={} \nsur \frac{\partial \muhatcw}{\partial \surcol{\y_i}},
$
take
$
\surcol{\w_i^\mrp} :={} \nsur \frac{\partial \muhatmrp}{\partial \surcol{\y_i}}.
...
\pause
The slope $\surcol{\w_i^\mrp}$ is a \textit{MrP locally equivalent weight}, or \textit{MrPlew}.\\[1em]
It measures the effect of local perturbations to $\surcol{\y_i}$ on the estimator $\tarcol{\muhat[\mrp]}$.\\[1em]

\textbf{Our main contribution is to rigorously connect this idea to CW diagnostics!}
