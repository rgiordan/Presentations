...
\begin{itemize}
%
\item As $N \rightarrow \infty$, the \blue{linear component} provides
an arbitrarily good approximation
\item Consistent variance estimates (the \red{errors} vanish in aggregate)
%
\end{itemize}
%
\pause
...
\begin{itemize}
%
\item The \blue{linear component} is the same order as the \red{error}
