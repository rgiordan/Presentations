...
\parencite{hampel1986robustbook}.
...
\onslide<6->{
    For Z-estimators, $\infl_n$ can be computed with the implicit
    function theorem.  (See our R package \texttt{zaminfluence}.)
}
...
\onslide<3->{
In Theorem 1 of \textcite{broderick:2025:automaticpart2}, we prove that
the linear approximation is accurate:
%
\begin{itemize}
\item For small $\alpha$ (\% dropped) 
\item Under standard technical conditions ($N \gg P$, bounded moments,
well-conditioned derivatives of $G$)
\end{itemize}
}
%
\onslide<4->{
Related and subsequent work has extended or refined our work! \parencite{
kuschnig:2021:HiddenPlainSight2021,
bakshi:2021:RobustLinearRegression2021,
moitra:2022:ProvablyAuditingOrdinary2022,
freund:2023:PracticalRobustnessAuditing2023a,
hu:2024:MostInfluentialSubset,
huang:2025:ApproximationsWorstcaseData2025,
rubinstein:2025:RobustnessAuditingLinear2025}

\textbf{Note:} The influence function can fail in high
dimensions (e.g.~simple random effect models), even for small $\alpha$.
\parencite{nguyen:2024:mcmcsensitivity,giordano2024bayesianinfinitesimaljackknifevariance}
}
