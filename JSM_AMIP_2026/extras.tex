...
\parencite{hampel1974influence, hampel1986robustbook}, which is based on the
...
``breakdown point'' \parencite{huber1981robust, huber:1983:notion}.
%
%\vspace{1em}
\begin{itemize}
...
\parencite{cook1977detection, belsley2005regression}.
%
\begin{itemize}
...
\begin{itemize}
    \item Cross-validation \parencite{giordano2019swiss}
    \item Prior sensitivity in Bayesian nonparametrics \parencite{giordano2021bnp}
