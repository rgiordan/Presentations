...
\bottomrule
\end{tabular}
\caption{ Cash transfers results (N = 10518) \parencite{angelucci2009indirect} }
...
\bottomrule
\end{tabular}
\caption{ Medicaid profit results (N = 23361) \parencite{finkelstein2012oregon} }
...
\bottomrule
\end{tabular}
\caption{ Microcredit Mexico results (N = 16560) \parencite{angelucci2015microcredit}. }
...
{\centering \includegraphics[width=0.98\linewidth,height=0.692\linewidth]{figure/sim-refit-one-1} 
...
{\centering \includegraphics[width=0.98\linewidth,height=0.692\linewidth]{figure/sim-refit-two-1} 
