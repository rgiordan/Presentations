...
{\centering \includegraphics[width=0.98\linewidth,height=0.461\linewidth]{figure/sim-infl-hist-1} 
...
{\centering \includegraphics[width=0.98\linewidth,height=0.461\linewidth]{figure/sim-refit-one-1} 
...
{\centering \includegraphics[width=0.98\linewidth,height=0.461\linewidth]{figure/sim-refit-two-1} 
...
{\centering \includegraphics[width=0.98\linewidth,height=0.553\linewidth]{figure/mx-hist-1} 
...
\newcommand{\GreedyDrop}{

\begin{knitrout}
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{figure}[!h]

{\centering \includegraphics[width=0.98\linewidth,height=0.553\linewidth]{figure/greedy-drop-1} 

}

\caption[MX profit analysis]{MX profit analysis}\label{fig:greedy-drop}
\end{figure}
...
\newcommand{\InfluentialKeep}{

\begin{knitrout}
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{figure}[!h]

{\centering \includegraphics[width=0.98\linewidth,height=0.553\linewidth]{figure/influential-keep-1} 

}

\caption[MX profit analysis]{MX profit analysis}\label{fig:influential-keep}
\end{figure}
...
{\centering \includegraphics[width=0.98\linewidth,height=0.553\linewidth]{figure/gd-path-1} 

}

\caption[MX profit analysis]{MX profit analysis}\label{fig:gd-path}
\end{figure}
...
{\centering \includegraphics[width=0.98\linewidth,height=0.553\linewidth]{figure/gd-refit-1} 

}

\caption[MX profit analysis]{MX profit analysis}\label{fig:gd-refit}
\end{figure}
