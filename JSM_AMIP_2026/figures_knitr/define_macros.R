...
DefineMacro("SimNumObs", sim_env$grid_list$num_obs, digits=1)
DefineMacro("SimTrueTheta", sim_env$grid_list$theta0, digits=1)

DefineMacro("SimAccNumObs", sim_env$acc_list$num_obs, digits=1)
DefineMacro("SimAccSigx", sim_env$acc_list$sig_x, digits=1)
DefineMacro("SimAccSigeps", sim_env$acc_list$sig_eps, digits=1)
DefineMacro("SimAccPercentMax", 100 * sim_env$acc_list$alpha_max, digits=1)
...
DefineMacro("MxNobs", mx_analysis_df$n_obs, digits=1)
