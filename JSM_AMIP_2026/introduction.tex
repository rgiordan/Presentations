...
\vspace{1em} \textbf{Example:} \textcite{angelucci2015microcredit}, a randomized
...
\vspace{0.5em} \textbf{Data dropping: } Can produce both positive and negative
...
Cannot find influential subsets by brute force!\\[0.5em]
...
\begin{itemize}
    \item Paper overview
    \begin{itemize}
        \item How do we approximately identify influential sets?  
        \item When is our approximation accurate?
    \end{itemize}
    \item Connections and disconnections
    \begin{itemize}
