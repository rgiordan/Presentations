...
\vspace{-1em}
\begin{itemize}
    \item[--] Hierarchical meta-analysis of microcredit \parencite{meager2020aggregating} \vspace{-0.5em}
    \item[--] Cash transfers randomized controlled trial \parencite{angelucci2009indirect} \vspace{-0.5em}
    \item[--] Oregon Medicaid experiment \parencite{finkelstein2012oregon} \vspace{-0.5em}
