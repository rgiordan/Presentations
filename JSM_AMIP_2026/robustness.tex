...
%
\begin{align*}
\textrm{Error} ={}& T(\fhat) - T(\flim + \shift)\\
={}&
...
Data dropping gives a simple notion of ``size:''

\textbf{Define} $\vnorm{\shift}$ = Proportion of points you need to drop to approximately
produce a change in $T$ as large as $\shift$ does. 
...
\begin{itemize}
    ...
    \item Not a norm ($\Delta \ne 0$ can have $\vnorm{\Delta} = 0$) nor a
