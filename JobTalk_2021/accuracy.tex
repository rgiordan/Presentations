...
probability approaching one. Then \thmref{accurate} applies with probability
approaching one.
\end{cor}
...
%
% \begin{itemize}
%     \item Regressors $x_n \sim \mathcal{N}(0, \sigma_x^2)$
%     \item Residuals $\varepsilon_n \sim \mathcal{N}(0, \sigma_\varepsilon^2)$
%     \item Responses $y_n = \theta_0 x_n + \varepsilon_n$.
% \end{itemize}
...
% \begin{align*}
% %
% \textrm{Regressors }x_n \sim \mathcal{N}(0, \sigma_x^2)\quad
% \textrm{Residuals }\varepsilon_n \sim \mathcal{N}(0, \sigma_\varepsilon^2)\quad
% \textrm{Responses }y_n = \theta_0 x_n + \varepsilon_n
% %
% \end{align*}
%
