...
\vspace{1em}
\textbf{You don't need to rely on the theory!}

\vspace{1em}
Our method returns the set of points to drop.  Re-running once without those
points provides an \textbf{exact lower bound} on the true worst-case
sensitivity.
