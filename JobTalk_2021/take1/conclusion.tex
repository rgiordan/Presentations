...
%
% See the paper for futher applications to:
% %\vspace{-1em}
% \begin{itemize}
%     \item[--] Hierarchical meta-analysis of microcredit \citep{meager2020aggregating} %\vspace{-0.5em}
%     \item[--] Cash transfers randomized controlled trial \citep{angelucci2009indirect}
%     %\vspace{-0.5em}
%     \item[--] Oregon Medicaid experiment \citep{finkelstein2012oregon}
%     %\vspace{-0.5em}
