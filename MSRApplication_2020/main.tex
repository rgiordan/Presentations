...
{\em Priors} encode key assumptions in Bayesian statistics, and inference can
be sensitive to prior specification, especially in high-dimensional models
like those of BNP.
% Checking for prior sensitivity is
% particularly important in high-dimensional models such as BNP, where the choice
% of prior is typically guided by mathematical convenience rather than subjective
% belief.
