...
{\centering \includegraphics[width=0.98\linewidth,height=0.784\linewidth]{figure/relerr_graph-1} 
...
{\centering \includegraphics[width=0.98\linewidth,height=0.784\linewidth]{figure/normerr_graph-1} 

}

\caption[The distribution of the relative errors.Log scale parameters include all variances or covariances that involve at least one log scale parameters]{The distribution of the relative errors.Log scale parameters include all variances or covariances that involve at least one log scale parameters.}\label{fig:normerr_graph}
\end{figure}
...
{\centering \includegraphics[width=0.98\linewidth,height=0.784\linewidth]{figure/interval_graph-1} 
...
{\centering \includegraphics[width=0.98\linewidth,height=0.784\linewidth]{figure/width_graph-1} 
...
{\centering \includegraphics[width=0.98\linewidth,height=0.549\linewidth]{figure/bats_data-1} 
...
{\centering \includegraphics[width=0.98\linewidth,height=0.784\linewidth]{figure/bats_result-1} 
...
{\centering \includegraphics[width=0.98\linewidth,height=0.549\linewidth]{figure/election_result-1} 
...
{\centering \includegraphics[width=0.98\linewidth,height=0.549\linewidth]{figure/election_state_result-1} 
...
{\centering \includegraphics[width=0.98\linewidth,height=0.549\linewidth]{figure/simple_sim_result-1} 
...
{\centering \includegraphics[width=0.98\linewidth,height=0.980\linewidth]{figure/poisson_re_graph-1} 
